...
const AISolutionsDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState('enterprise'); // 'enterprise' of 'product'
  ...
  return (
    <div className="grid grid-cols-12 gap-6">
      <div className="col-span-12 bg-white rounded-2xl shadow-xl p-8">
        <h2 className="text-2xl font-bold" style={{background: 'linear-gradient(90deg, #54BAFC 0%, #0066CC 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>
          AI Solutions for your product team
        </h2>
        <p className="mt-2 text-slate-600">
          Hier komt een overzicht met tools en patronen voor productteams, denk aan ideation, UX copy, experiment design, backlog grooming en analytics.
        </p>
      </div>
    </div>
  );
